    ...
    >
        ...
        >
          ...
          <motion.div variants={fadeUp} style={{ marginBottom: '1.5rem' }}>
            <span className="section-badge">
              Premium Signage Solutions in Mumbai
            </span>
          </motion.div>
          ...
          >
            Crafting{' '}
            <span className="glow-text">Memories</span>
            <br />
            in Signage
          </motion.h1>
          ...
          >
            Transform your brand presence with stunning 3D signage, neon displays,
            LED signs, and cutting-edge sign solutions that leave lasting impressions.
          </motion.p>
      ...
      >
        ...
        <div style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(90deg, #FFF8F4 0%, rgba(255,248,244,0.4) 20%, transparent 45%)',
        }} />
        ...
        <div style={{
          ...
          right: 0,
          height: '40%',
          background: 'linear-gradient(0deg, rgba(255,248,244,0.6) 0%, transparent 100%)',
        }} />
        ...
        <motion.div
          ...
          transition={{ delay: 1.2, duration: 0.6, ease: [0.34, 1.56, 0.64, 1] as const }}
          style={{
            position: 'absolute',
            top: '6rem',
            right: '2rem',
        ...
        >
          ...
          <span style={{ fontSize: '0.8rem', fontWeight: 600, color: '#1E1E2A' }}>
            3D &amp; LED Signs
          </span>
        </motion.div>
        ...
        <motion.div
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ delay: 1.5, duration: 0.6, ease: [0.34, 1.56, 0.64, 1] as const }}
          style={{
            position: 'absolute',
            bottom: '6rem',
            left: '2rem',
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="#D45C2A">
      ...
      >
        <span style={{ fontSize: '0.7rem', color: 'var(--text-muted)', letterSpacing: '0.1em' }}>SCROLL</span>
        <motion.div
          animate={{ y: [0, 6, 0] }}
